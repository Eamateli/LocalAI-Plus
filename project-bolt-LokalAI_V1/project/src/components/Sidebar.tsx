...
interface SidebarProps {
  collapsed: boolean;
  onToggle: () => void;
  currentView: 'chat' | 'simple-chat' | 'settings' | 'library' | 'library-ii' | 'projects';
  onViewChange: (view: 'chat' | 'simple-chat' | 'settings' | 'library' | 'library-ii' | 'projects') => void;
  ...
  const menuItems = [
    {
      ...
      icon: MessageSquare,
      view: 'chat' as const,
      enabled: true, // Chat is always enabled
    },
    {
      id: 'simple-chat',
      label: 'Simple Chat List',
      icon: List,
      view: 'simple-chat' as const,
      enabled: featuresEnabled.simpleChat,
    },
    {
      id: 'library',
      label: 'Library',
      ...
      enabled: featuresEnabled.library,
    },
    {
      id: 'library-ii',
      label: 'Library II',
      icon: BarChart3,
      view: 'library-ii' as const,
      enabled: featuresEnabled.libraryII,
    },
    {
      id: 'projects',
      label: 'Projects',
      ...
      enabled: true, // Projects is always enabled
    },
    {
      id: 'settings',
      label: 'Settings',
  ...
  return (
    <>
      ...
      >
        ...
        {/* Chat Sessions - Only show for main chat view */}
        ...
        {!collapsed && (
          <div className="p-4 border-t border-gray-200 dark:border-gray-700">
            <div className="text-xs text-gray-500 dark:text-gray-400">
              <p className="font-medium mb-1">Active Features:</p>
              <div className="space-y-1">
                {featuresEnabled.library && <p>• Library System</p>}
                {featuresEnabled.libraryII && <p>• Library II Analytics</p>}
                {featuresEnabled.simpleChat && <p>• Simple Chat List</p>}
